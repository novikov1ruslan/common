...
public class ProgressManager {
    ...
    @NonNull
    private final ProgressSettings mSettings;
    @NonNull
    private final String mSnapshotName;

    public ProgressManager(@NonNull ApiClient apiClient, @NonNull ProgressSettings settings,
    ...
    public void synchronize() {
        if (mApiClient.isConnected()) {
            ...
            mApiClient.openAsynchronously(mSnapshotName, new OpenSnapshotResultResultCallback());
        } else {
